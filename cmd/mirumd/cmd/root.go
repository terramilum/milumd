...
func NewRootCmd() *cobra.Command {
	...
	initClientCtx := client.Context{}.
		...
		WithHomeDir(mirumapp.DefaultNodeHome).
		WithViper("")
...
func initRootCmd(rootCmd *cobra.Command,
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(basicManager, mirumapp.DefaultNodeHome),
		tmcli.NewCompletionCmd(rootCmd, true),
		NewTestnetCmd(basicManager, banktypes.GenesisBalancesIterator{}, ac),
		addDebugCommands(debug.Cmd()),
		confixcmd.ConfigCommand(),
		pruning.Cmd(ac.newApp, mirumapp.DefaultNodeHome),
		snapshot.Cmd(ac.newApp),
	)

	server.AddCommands(rootCmd, mirumapp.DefaultNodeHome, ac.newApp, ac.appExport, addModuleInitFlags)
...
func genesisCommand(txConfig client.TxConfig, basicManager module.BasicManager, cmds ...*cobra.Command) *cobra.Command {
	cmd := genutilcli.GenesisCoreCommand(txConfig, basicManager, mirumapp.DefaultNodeHome)
...
var tempDir = func() string {
	dir, err := os.MkdirTemp("", ".mirumd")
	if err != nil {
		dir = mirumapp.DefaultNodeHome
	}
