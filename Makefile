...
HTTPS_GIT := https://github.com/terramilum/milumd.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=trm \
		  ...
		  -X github.com/terramilum/milumd/app.Bech32Prefix=trm \
...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/lcd/statik/statik.go" | xargs goimports -w -local github.com/terramilum/milumd
