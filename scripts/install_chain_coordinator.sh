...
then 
    sed -i 's/"time_iota_ms": "1000"/"time_iota_ms": "100"/' $GENESIS
else   
...
echo "$PASSWORD" | mirumd genesis add-genesis-account validator "10000000000000000$STAKE" --home "$HOMEP"

# submit a genesis validator tx
## Workraround for https://github.com/cosmos/cosmos-sdk/issues/8251
(echo "$PASSWORD"; echo "$PASSWORD"; echo "$PASSWORD") | mirumd genesis gentx validator "100000000000$STAKE" --chain-id="$CHAIN_ID" --amount="100000000000$STAKE" --home "$HOMEP"
## should be:
